...
- [fzf-tab-completion](https://github.com/lincheney/fzf-tab-completion), for fzf-powered tab completion in Bash, Zsh, Python3, Nodejs, and Readline-powered applications.
